...
set CLASSPATH=%APP_HOME%\lib\lab3-1.0-SNAPSHOT.jar;%APP_HOME%\lib\log4j-core-2.23.1.jar;%APP_HOME%\lib\log4j-api-2.23.1.jar;%APP_HOME%\lib\sqlite-jdbc-3.49.1.0.jar
